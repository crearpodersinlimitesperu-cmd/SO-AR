...
export const checklistData = [
  ...
  // ============================================================================
  // CHECKLISTS OPERATIVOS OFICIALES DE ROL (DESDE GOOGLE DRIVE CAJA NEGRA)
  // Integración no destructiva de manuales cíclicos: Capitán, QT, Gerente, Coordinación C1/C2 y Maestría
  // ============================================================================
  { id: "cap_chk_1", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar estado de su equipo.", isCritical: false },
  { id: "cap_chk_2", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar comunicación con aliados.", isCritical: false },
  { id: "cap_chk_3", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar participantes asignados.", isCritical: false },
  { id: "cap_chk_4", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar compromisos.", isCritical: false },
  { id: "cap_chk_5", role: "capitan", cyclePhase: "PRE-C1", task: "Detectar quiebres.", isCritical: true },
  { id: "cap_chk_6", role: "capitan", cyclePhase: "PRE-C1", task: "Contactar a los aliados que requieran intervención.", isCritical: false },
  { id: "cap_chk_7", role: "capitan", cyclePhase: "PRE-C1", task: "Confirmar actividad del equipo.", isCritical: true },
  { id: "cap_chk_8", role: "capitan", cyclePhase: "PRE-C1", task: "Mantener contacto con aliados.", isCritical: false },
  { id: "cap_chk_9", role: "capitan", cyclePhase: "PRE-C1", task: "Acompañar quiebres.", isCritical: true },
  { id: "cap_chk_10", role: "capitan", cyclePhase: "PRE-C1", task: "Verificar que cada aliado conozca sus responsabilidades.", isCritical: false },
  { id: "cap_chk_11", role: "capitan", cyclePhase: "PRE-C1", task: "Mantener actualizado el estado de su equipo.", isCritical: false },
  { id: "cap_chk_12", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar personalmente los grupos.", isCritical: false },
  { id: "cap_chk_13", role: "capitan", cyclePhase: "PRE-C1", task: "Contactar aliados que no estén ejecutando.", isCritical: false },
  { id: "cap_chk_14", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar participantes críticos.", isCritical: true },
  { id: "cap_chk_15", role: "capitan", cyclePhase: "PRE-C1", task: "Informar al QT cualquier quiebre relevante.", isCritical: true },
  { id: "cap_chk_16", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar estado completo del equipo.", isCritical: false },
  { id: "cap_chk_17", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar productividad, llamadas programadas y realizadas.", isCritical: false },
  { id: "cap_chk_18", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar participantes sin respuesta o indecisos.", isCritical: false },
  { id: "cap_chk_19", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar compromisos y PP%.", isCritical: false },
  { id: "cap_chk_20", role: "capitan", cyclePhase: "PRE-C1", task: "Definir intervención individual (responsable, fecha).", isCritical: false },
  { id: "cap_chk_21", role: "capitan", cyclePhase: "PRE-C1", task: "Registrar acuerdos.", isCritical: false },
  { id: "cap_chk_22", role: "capitan", cyclePhase: "C1", task: "Reunión de alineación completada.", isCritical: true },
  { id: "cap_chk_23", role: "capitan", cyclePhase: "C1", task: "Roles, puertas y responsables asignados.", isCritical: false },
  { id: "cap_chk_24", role: "capitan", cyclePhase: "C1", task: "Drills practicados.", isCritical: false },
  { id: "cap_chk_25", role: "capitan", cyclePhase: "C1", task: "Aliados alineados y parejas sombra asignadas.", isCritical: false },
  { id: "cap_chk_26", role: "capitan", cyclePhase: "C1", task: "Directorios y gafetes revisados.", isCritical: false },
  { id: "cap_chk_27", role: "capitan", cyclePhase: "C1", task: "Grupos de WhatsApp preparados.", isCritical: false },
  { id: "cap_chk_28", role: "capitan", cyclePhase: "C1", task: "Equipo en posición.", isCritical: false },
  { id: "cap_chk_29", role: "capitan", cyclePhase: "C1", task: "Liderar al equipo.", isCritical: false },
  { id: "cap_chk_30", role: "capitan", cyclePhase: "C1", task: "Mantener alineación y cuidar ejecución.", isCritical: true },
  { id: "cap_chk_31", role: "capitan", cyclePhase: "C1", task: "Supervisar aliados y detectar quiebres.", isCritical: true },
  { id: "cap_chk_32", role: "capitan", cyclePhase: "C1", task: "Mantener comunicación con QT.", isCritical: false },
  { id: "cap_chk_33", role: "capitan", cyclePhase: "C1", task: "Resolver desviaciones operativas.", isCritical: false },
  { id: "cap_chk_34", role: "capitan", cyclePhase: "C1", task: "Verificar grupos de creación (Presentación, nombre, propósito, grito, reglas, grupo WhatsApp, directorio entregado).", isCritical: false },
  { id: "cap_chk_35", role: "capitan", cyclePhase: "C1", task: "Llegar antes del horario establecido.", isCritical: false },
  { id: "cap_chk_36", role: "capitan", cyclePhase: "C1", task: "Grounding del equipo.", isCritical: false },
  { id: "cap_chk_37", role: "capitan", cyclePhase: "C1", task: "Revisar responsabilidades, energía y presencia.", isCritical: false },
  { id: "cap_chk_38", role: "capitan", cyclePhase: "C1", task: "Detectar quiebres y coordinar con QT.", isCritical: true },
  { id: "cap_chk_39", role: "capitan", cyclePhase: "C1", task: "Dar feedback oportuno y mantener equipo alineado.", isCritical: false },
  { id: "cap_chk_40", role: "capitan", cyclePhase: "C1", task: "Preparar equipo para cierre.", isCritical: false },
  { id: "cap_chk_41", role: "capitan", cyclePhase: "C1", task: "Revisar participantes e identificar liderazgo emergente.", isCritical: false },
  { id: "cap_chk_42", role: "capitan", cyclePhase: "C1", task: "Acompañar conversaciones y coordinar cierre del equipo.", isCritical: false },
  { id: "cap_chk_43", role: "capitan", cyclePhase: "C1", task: "Entregar información relevante al QT.", isCritical: false },
  { id: "cap_chk_44", role: "capitan", cyclePhase: "PRE-C1", task: "Verificar contacto de aliados (Lunes, Miércoles, Viernes).", isCritical: false },
  { id: "cap_chk_45", role: "capitan", cyclePhase: "PRE-C1", task: "Revisar participantes sin contacto y compromisos.", isCritical: false },
  { id: "cap_chk_46", role: "capitan", cyclePhase: "PRE-C1", task: "Detectar riesgos de pérdida y escalar casos.", isCritical: false },
  { id: "cap_chk_47", role: "capitan", cyclePhase: "C2", task: "Confirmar participantes de su equipo.", isCritical: true },
  { id: "cap_chk_48", role: "capitan", cyclePhase: "C2", task: "Acompañar decisiones.", isCritical: false },
  { id: "cap_chk_49", role: "capitan", cyclePhase: "C2", task: "Mantener comunicación.", isCritical: false },
  { id: "cap_chk_50", role: "capitan", cyclePhase: "C2", task: "Liderar equipo.", isCritical: false },
  { id: "cap_chk_51", role: "capitan", cyclePhase: "C2", task: "Sostener aliados.", isCritical: false },
  { id: "cap_chk_52", role: "capitan", cyclePhase: "C2", task: "Acompañar participantes.", isCritical: false },
  { id: "cap_chk_53", role: "capitan", cyclePhase: "C2", task: "Mantener estándares.", isCritical: false },
  { id: "cap_chk_54", role: "capitan", cyclePhase: "C2", task: "Cerrar seguimiento.", isCritical: false },
  { id: "cap_chk_55", role: "capitan", cyclePhase: "C2", task: "Evaluar desempeño de aliados.", isCritical: false },
  { id: "cap_chk_56", role: "capitan", cyclePhase: "C2", task: "Identificar candidatos a crecimiento.", isCritical: false },
  { id: "cap_chk_57", role: "capitan", cyclePhase: "C2", task: "Entregar información al QT.", isCritical: false },
  { id: "qt_chk_1", role: "qt", cyclePhase: "PRE-C1", task: "Auditar estado de los equipos.", isCritical: false },
  { id: "qt_chk_2", role: "qt", cyclePhase: "PRE-C1", task: "Revisar productividad y seguimiento.", isCritical: false },
  { id: "qt_chk_3", role: "qt", cyclePhase: "PRE-C1", task: "Identificar aliados desconectados y participantes críticos.", isCritical: true },
  { id: "qt_chk_4", role: "qt", cyclePhase: "PRE-C1", task: "Informar quiebres al Capitán.", isCritical: true },
  { id: "qt_chk_5", role: "qt", cyclePhase: "PRE-C1", task: "Escalar al nivel correspondiente.", isCritical: false },
  { id: "qt_chk_6", role: "qt", cyclePhase: "PRE-C1", task: "Acompañar a Capitanes y auditar ejecución.", isCritical: false },
  { id: "qt_chk_7", role: "qt", cyclePhase: "PRE-C1", task: "Corregir desviaciones y entrenar al equipo.", isCritical: false },
  { id: "qt_chk_8", role: "qt", cyclePhase: "PRE-C1", task: "Verificar cumplimiento de estándares.", isCritical: false },
  { id: "qt_chk_9", role: "qt", cyclePhase: "PRE-C1", task: "Auditar Capitanes y revisar consistencia de ejecución.", isCritical: false },
  { id: "qt_chk_10", role: "qt", cyclePhase: "PRE-C1", task: "Identificar patrones repetitivos, entrenar y corregir.", isCritical: false },
  { id: "qt_chk_11", role: "qt", cyclePhase: "PRE-C1", task: "Revisar estado completo del equipo y productividad.", isCritical: false },
  { id: "qt_chk_12", role: "qt", cyclePhase: "PRE-C1", task: "Revisar llamadas, participantes sin respuesta e indecisos.", isCritical: false },
  { id: "qt_chk_13", role: "qt", cyclePhase: "PRE-C1", task: "Revisar compromisos y PP%.", isCritical: false },
  { id: "qt_chk_14", role: "qt", cyclePhase: "PRE-C1", task: "Definir intervención individual (responsable, fecha) y registrar acuerdos.", isCritical: false },
  { id: "qt_chk_15", role: "qt", cyclePhase: "C1", task: "Ensayar drills con aliados.", isCritical: false },
  { id: "qt_chk_16", role: "qt", cyclePhase: "C1", task: "Confirmar postura, presentación y conocimiento del flujo.", isCritical: true },
  { id: "qt_chk_17", role: "qt", cyclePhase: "C1", task: "Confirmar responsables de cada posición.", isCritical: true },
  { id: "qt_chk_18", role: "qt", cyclePhase: "C1", task: "Confirmar música, luces, puertas, materiales y baúl de celulares.", isCritical: true },
  { id: "qt_chk_19", role: "qt", cyclePhase: "C1", task: "Confirmar ambiente de sala.", isCritical: true },
  { id: "qt_chk_20", role: "qt", cyclePhase: "C1", task: "Ser soporte del entrenador y del Capitán.", isCritical: false },
  { id: "qt_chk_21", role: "qt", cyclePhase: "C1", task: "Observar el contexto y detectar quiebres.", isCritical: true },
  { id: "qt_chk_22", role: "qt", cyclePhase: "C1", task: "Cuidar estándares y acompañar aliados.", isCritical: false },
  { id: "qt_chk_23", role: "qt", cyclePhase: "C1", task: "Proteger la experiencia del participante.", isCritical: false },
  { id: "qt_chk_24", role: "qt", cyclePhase: "C1", task: "Mantener presencia y escalar situaciones relevantes.", isCritical: false },
  { id: "qt_chk_25", role: "qt", cyclePhase: "C1", task: "No abandonar posiciones críticas.", isCritical: false },
  { id: "qt_chk_26", role: "qt", cyclePhase: "C1", task: "Grounding previo y revisar posiciones/aliados.", isCritical: false },
  { id: "qt_chk_27", role: "qt", cyclePhase: "C1", task: "Observar participantes que requieren atención.", isCritical: false },
  { id: "qt_chk_28", role: "qt", cyclePhase: "C1", task: "Mantener contexto y coordinar intervenciones.", isCritical: false },
  { id: "qt_chk_29", role: "qt", cyclePhase: "C1", task: "Revisar operación de sala y mantener estándares.", isCritical: false },
  { id: "qt_chk_30", role: "qt", cyclePhase: "C1", task: "Identificar líderes potenciales y observar conversaciones.", isCritical: false },
  { id: "qt_chk_31", role: "qt", cyclePhase: "C1", task: "Revisar compromiso y avance hacia C2.", isCritical: false },
  { id: "qt_chk_32", role: "qt", cyclePhase: "C1", task: "Registrar oportunidades y preparar seguimiento posterior.", isCritical: false },
  { id: "qt_chk_33", role: "qt", cyclePhase: "PRE-C1", task: "Auditar seguimiento y revisar productividad/conversión.", isCritical: false },
  { id: "qt_chk_34", role: "qt", cyclePhase: "PRE-C1", task: "Entrenar al Capitán e intervenir en casos críticos.", isCritical: true },
  { id: "qt_chk_35", role: "qt", cyclePhase: "C2", task: "Auditar conversión, revisar participantes indecisos y PP%.", isCritical: false },
  { id: "qt_chk_36", role: "qt", cyclePhase: "C2", task: "Revisar llamadas, diseñar intervenciones y confirmar asientos de C2.", isCritical: true },
  { id: "qt_chk_37", role: "qt", cyclePhase: "C2", task: "Auditar, observar, entrenar, corregir.", isCritical: false },
  { id: "qt_chk_38", role: "qt", cyclePhase: "C2", task: "Identificar liderazgo y registrar resultados.", isCritical: false },
  { id: "qt_chk_39", role: "qt", cyclePhase: "C2", task: "Evaluar Capitanes y aliados.", isCritical: false },
  { id: "qt_chk_40", role: "qt", cyclePhase: "C2", task: "Revisar resultados e identificar futuros líderes.", isCritical: false },
  { id: "qt_chk_41", role: "qt", cyclePhase: "C2", task: "Preparar desarrollo del siguiente ciclo.", isCritical: false },
  { id: "qt_chk_42", role: "qt", cyclePhase: "PRE-MJ", task: "Preparar equipo.", isCritical: false },
  { id: "qt_chk_43", role: "qt", cyclePhase: "PRE-MJ", task: "Revisar evolución de Capitanes y aliados.", isCritical: false },
  { id: "qt_chk_44", role: "qt", cyclePhase: "PRE-MJ", task: "Preparar observaciones y recomendaciones.", isCritical: false },
  { id: "ger_chk_1", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar tablero general de operación.", isCritical: false },
  { id: "ger_chk_2", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar resultados del entrenamiento anterior.", isCritical: false },
  { id: "ger_chk_3", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar asistencia.", isCritical: false },
  { id: "ger_chk_4", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar conversiones.", isCritical: false },
  { id: "ger_chk_5", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar pendientes críticos.", isCritical: true },
  { id: "ger_chk_6", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar incidencias.", isCritical: false },
  { id: "ger_chk_7", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar necesidades de cada coordinación.", isCritical: false },
  { id: "ger_chk_8", role: "gerente", cyclePhase: "PRE-C1", task: "Identificar quiebres que requieren intervención.", isCritical: true },
  { id: "ger_chk_9", role: "gerente", cyclePhase: "PRE-C1", task: "Definir prioridades de la semana.", isCritical: false },
  { id: "ger_chk_10", role: "gerente", cyclePhase: "PRE-C1", task: "Confirmar responsables y fechas de cumplimiento.", isCritical: true },
  { id: "ger_chk_11", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar cumplimiento de prioridades.", isCritical: false },
  { id: "ger_chk_12", role: "gerente", cyclePhase: "PRE-C1", task: "Resolver bloqueos.", isCritical: true },
  { id: "ger_chk_13", role: "gerente", cyclePhase: "PRE-C1", task: "Verificar coordinación entre áreas.", isCritical: false },
  { id: "ger_chk_14", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar indicadores.", isCritical: false },
  { id: "ger_chk_15", role: "gerente", cyclePhase: "PRE-C1", task: "Confirmar que no existan pendientes críticos sin responsable.", isCritical: true },
  { id: "ger_chk_16", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar compromisos y resolver quiebres antes del fin de semana.", isCritical: true },
  { id: "ger_chk_17", role: "gerente", cyclePhase: "PRE-C1", task: "Recibir indicadores relevantes.", isCritical: false },
  { id: "ger_chk_18", role: "gerente", cyclePhase: "PRE-C1", task: "Revisar desviaciones.", isCritical: false },
  { id: "ger_chk_19", role: "gerente", cyclePhase: "PRE-C1", task: "Intervenir cuando el quiebre supere el nivel operativo.", isCritical: true },
  { id: "ger_chk_20", role: "gerente", cyclePhase: "PRE-C1", task: "Confirmar que exista plan de acción.", isCritical: true },
  { id: "ger_chk_21", role: "gerente", cyclePhase: "C1", task: "Mantener supervisión ejecutiva.", isCritical: false },
  { id: "ger_chk_22", role: "gerente", cyclePhase: "C1", task: "Resolver escalaciones.", isCritical: false },
  { id: "ger_chk_23", role: "gerente", cyclePhase: "C1", task: "No interferir innecesariamente en la operación de cancha.", isCritical: false },
  { id: "ger_chk_24", role: "gerente", cyclePhase: "C1", task: "Revisar cumplimiento de estándares.", isCritical: false },
  { id: "ger_chk_25", role: "gerente", cyclePhase: "C1", task: "Registrar incidencias relevantes.", isCritical: false },
  { id: "ger_chk_26", role: "gerente", cyclePhase: "C2", task: "Supervisión ejecutiva.", isCritical: false },
  { id: "ger_chk_27", role: "gerente", cyclePhase: "C2", task: "Indicadores.", isCritical: false },
  { id: "ger_chk_28", role: "gerente", cyclePhase: "C2", task: "Incidencias.", isCritical: false },
  { id: "ger_chk_29", role: "gerente", cyclePhase: "C2", task: "Coordinación general.", isCritical: false },
  { id: "ger_chk_30", role: "gerente", cyclePhase: "C2", task: "Cierre administrativo.", isCritical: false },
  { id: "ger_chk_31", role: "gerente", cyclePhase: "C2", task: "Revisar resultados.", isCritical: false },
  { id: "ger_chk_32", role: "gerente", cyclePhase: "C2", task: "Revisar aprendizajes.", isCritical: false },
  { id: "ger_chk_33", role: "gerente", cyclePhase: "C2", task: "Preparar cierre de ciclo.", isCritical: false },
  { id: "ger_chk_34", role: "gerente", cyclePhase: "PRE-MJ", task: "Consolidar resultados del ciclo.", isCritical: false },
  { id: "ger_chk_35", role: "gerente", cyclePhase: "PRE-MJ", task: "Revisar KPIs.", isCritical: false },
  { id: "ger_chk_36", role: "gerente", cyclePhase: "PRE-MJ", task: "Revisar quiebres.", isCritical: true },
  { id: "ger_chk_37", role: "gerente", cyclePhase: "PRE-MJ", task: "Revisar desempeño de coordinaciones.", isCritical: false },
  { id: "ger_chk_38", role: "gerente", cyclePhase: "PRE-MJ", task: "Preparar reunión de cierre.", isCritical: false },
  { id: "ger_chk_39", role: "gerente", cyclePhase: "PRE-C1", task: "¿Cuántos participantes tenemos?", isCritical: false },
  { id: "ger_chk_40", role: "gerente", cyclePhase: "PRE-C1", task: "¿Dónde está cada participante?", isCritical: false },
  { id: "ger_chk_41", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién está en riesgo?", isCritical: false },
  { id: "ger_chk_42", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién necesita intervención?", isCritical: false },
  { id: "ger_chk_43", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién está avanzando?", isCritical: false },
  { id: "ger_chk_44", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién es responsable?", isCritical: false },
  { id: "ger_chk_45", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién está ejecutando?", isCritical: false },
  { id: "ger_chk_46", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién está desconectado?", isCritical: false },
  { id: "ger_chk_47", role: "gerente", cyclePhase: "PRE-C1", task: "¿Qué Capitán necesita apoyo?", isCritical: false },
  { id: "ger_chk_48", role: "gerente", cyclePhase: "PRE-C1", task: "¿Qué QT necesita intervención?", isCritical: false },
  { id: "ger_chk_49", role: "gerente", cyclePhase: "PRE-C1", task: "¿Qué entrenamiento viene?", isCritical: false },
  { id: "ger_chk_50", role: "gerente", cyclePhase: "PRE-C1", task: "¿Qué falta?", isCritical: false },
  { id: "ger_chk_51", role: "gerente", cyclePhase: "PRE-C1", task: "¿Quién lo tiene?", isCritical: false },
  { id: "ger_chk_52", role: "gerente", cyclePhase: "PRE-C1", task: "¿Cuál es el riesgo?", isCritical: false },
  { id: "ger_chk_53", role: "gerente", cyclePhase: "PRE-C1", task: "¿Cuál es el siguiente hito?", isCritical: false },
  { id: "ger_chk_54", role: "gerente", cyclePhase: "PRE-C1", task: "Asistencia.", isCritical: false },
  { id: "ger_chk_55", role: "gerente", cyclePhase: "PRE-C1", task: "Confirmaciones.", isCritical: false },
  { id: "ger_chk_56", role: "gerente", cyclePhase: "PRE-C1", task: "Seguimiento.", isCritical: false },
  { id: "ger_chk_57", role: "gerente", cyclePhase: "PRE-C1", task: "Conversión.", isCritical: false },
  { id: "ger_chk_58", role: "gerente", cyclePhase: "PRE-C1", task: "Pagos.", isCritical: false },
  { id: "ger_chk_59", role: "gerente", cyclePhase: "PRE-C1", task: "Retención.", isCritical: false },
  { id: "ger_chk_60", role: "gerente", cyclePhase: "PRE-C1", task: "Desarrollo de liderazgo.", isCritical: false },
  { id: "cc1_chk_1", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar base de participantes.", isCritical: false },
  { id: "cc1_chk_2", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar estados de confirmación.", isCritical: false },
  { id: "cc1_chk_3", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar casos pendientes.", isCritical: false },
  { id: "cc1_chk_4", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar llamadas realizadas.", isCritical: false },
  { id: "cc1_chk_5", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar participantes sin contacto.", isCritical: false },
  { id: "cc1_chk_6", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar devoluciones.", isCritical: false },
  { id: "cc1_chk_7", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar próximos pasos.", isCritical: false },
  { id: "cc1_chk_8", role: "coord_c1", cyclePhase: "PRE-C1", task: "Actualizar CRM.", isCritical: false },
  { id: "cc1_chk_9", role: "coord_c1", cyclePhase: "PRE-C1", task: "Asignar casos pendientes.", isCritical: false },
  { id: "cc1_chk_10", role: "coord_c1", cyclePhase: "PRE-C1", task: "Continuar seguimiento de participantes.", isCritical: false },
  { id: "cc1_chk_11", role: "coord_c1", cyclePhase: "PRE-C1", task: "Actualizar estados.", isCritical: false },
  { id: "cc1_chk_12", role: "coord_c1", cyclePhase: "PRE-C1", task: "Ejecutar derivaciones.", isCritical: false },
  { id: "cc1_chk_13", role: "coord_c1", cyclePhase: "PRE-C1", task: "Cerrar casos resueltos.", isCritical: false },
  { id: "cc1_chk_14", role: "coord_c1", cyclePhase: "PRE-C1", task: "Registrar conversaciones.", isCritical: false },
  { id: "cc1_chk_15", role: "coord_c1", cyclePhase: "PRE-C1", task: "Identificar casos que necesitan intervención del Capitán/QT.", isCritical: false },
  { id: "cc1_chk_16", role: "coord_c1", cyclePhase: "PRE-C1", task: "Revisar compromisos, resolver antes de que el quiebre llegue al fin de semana, registrar intervención.", isCritical: true },
  { id: "cc1_chk_17", role: "coord_c1", cyclePhase: "C1", task: "Confirmar participantes.", isCritical: true },
  { id: "cc1_chk_18", role: "coord_c1", cyclePhase: "C1", task: "Confirmar equipo.", isCritical: true },
  { id: "cc1_chk_19", role: "coord_c1", cyclePhase: "C1", task: "Confirmar logística.", isCritical: true },
  { id: "cc1_chk_20", role: "coord_c1", cyclePhase: "C1", task: "Confirmar materiales.", isCritical: true },
  { id: "cc1_chk_21", role: "coord_c1", cyclePhase: "C1", task: "Confirmar sala.", isCritical: true },
  { id: "cc1_chk_22", role: "coord_c1", cyclePhase: "C1", task: "Confirmar presentaciones oficiales.", isCritical: true },
  { id: "cc1_chk_23", role: "coord_c1", cyclePhase: "C1", task: "Confirmar audio.", isCritical: true },
  { id: "cc1_chk_24", role: "coord_c1", cyclePhase: "C1", task: "Confirmar iluminación.", isCritical: true },
  { id: "cc1_chk_25", role: "coord_c1", cyclePhase: "C1", task: "Confirmar música.", isCritical: true },
  { id: "cc1_chk_26", role: "coord_c1", cyclePhase: "C1", task: "Confirmar responsables.", isCritical: true },
  { id: "cc1_chk_27", role: "coord_c1", cyclePhase: "C1", task: "Mantener control de participantes.", isCritical: false },
  { id: "cc1_chk_28", role: "coord_c1", cyclePhase: "C1", task: "Resolver incidencias administrativas.", isCritical: false },
  { id: "cc1_chk_29", role: "coord_c1", cyclePhase: "C1", task: "Mantener información actualizada.", isCritical: false },
  { id: "cc1_chk_30", role: "coord_c1", cyclePhase: "C1", task: "Coordinar con oficina.", isCritical: false },
  { id: "cc1_chk_31", role: "coord_c1", cyclePhase: "C1", task: "Atender derivaciones.", isCritical: false },
  { id: "cc1_chk_32", role: "coord_c1", cyclePhase: "C1", task: "Registrar novedades.", isCritical: false },
  { id: "cc1_chk_33", role: "coord_c1", cyclePhase: "C1", task: "Resolver incidencias.", isCritical: false },
  { id: "cc1_chk_34", role: "coord_c1", cyclePhase: "C1", task: "Mantener control de asistencia.", isCritical: false },
  { id: "cc1_chk_35", role: "coord_c1", cyclePhase: "C1", task: "Coordinar requerimientos.", isCritical: false },
  { id: "cc1_chk_36", role: "coord_c1", cyclePhase: "C1", task: "Preparar operación del domingo.", isCritical: false },
  { id: "cc1_chk_37", role: "coord_c1", cyclePhase: "C1", task: "Confirmar asistencia.", isCritical: true },
  { id: "cc1_chk_38", role: "coord_c1", cyclePhase: "C1", task: "Consolidar información.", isCritical: false },
  { id: "cc1_chk_39", role: "coord_c1", cyclePhase: "C1", task: "Registrar resultados.", isCritical: false },
  { id: "cc1_chk_40", role: "coord_c1", cyclePhase: "C1", task: "Identificar pendientes.", isCritical: false },
  { id: "cc1_chk_41", role: "coord_c1", cyclePhase: "C1", task: "Preparar información para seguimiento.", isCritical: false },
  { id: "cc1_chk_42", role: "coord_c1", cyclePhase: "C1", task: "Coordinar proceso de C2.", isCritical: false },
  { id: "cc1_chk_43", role: "coord_c1", cyclePhase: "C2", task: "Confirmar pagos.", isCritical: true },
  { id: "cc1_chk_44", role: "coord_c1", cyclePhase: "C2", task: "Actualizar base.", isCritical: false },
  { id: "cc1_chk_45", role: "coord_c1", cyclePhase: "C2", task: "Asistencia.", isCritical: false },
  { id: "cc1_chk_46", role: "coord_c1", cyclePhase: "C2", task: "Registro.", isCritical: false },
  { id: "cc1_chk_47", role: "coord_c1", cyclePhase: "C2", task: "Participantes.", isCritical: false },
  { id: "cc1_chk_48", role: "coord_c1", cyclePhase: "C2", task: "Incidencias.", isCritical: false },
  { id: "cc1_chk_49", role: "coord_c1", cyclePhase: "C2", task: "Información.", isCritical: false },
  { id: "cc1_chk_50", role: "coord_c1", cyclePhase: "C2", task: "Cierre.", isCritical: false },
  { id: "cc1_chk_51", role: "coord_c1", cyclePhase: "C2", task: "Cerrar casos.", isCritical: false },
  { id: "cc1_chk_52", role: "coord_c1", cyclePhase: "C2", task: "Preparar reporte.", isCritical: false },
  { id: "cmj_chk_1", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar estado de Maestría.", isCritical: false },
  { id: "cmj_chk_2", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar compromisos pendientes.", isCritical: false },
  { id: "cmj_chk_3", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar participantes que requieren seguimiento.", isCritical: false },
  { id: "cmj_chk_4", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar necesidades del entrenador.", isCritical: false },
  { id: "cmj_chk_5", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar avances de formación de equipo.", isCritical: false },
  { id: "cmj_chk_6", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Actualizar pendientes.", isCritical: false },
  { id: "cmj_chk_7", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Escalar quiebres al Gerente.", isCritical: true },
  { id: "cmj_chk_8", role: "coord_maestria", cyclePhase: "PRE-C1", task: "Revisar compromisos, resolver antes de que el quiebre llegue al fin de semana, registrar intervención.", isCritical: true },
  { id: "cmj_chk_9", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Preparar operación.", isCritical: false },
  { id: "cmj_chk_10", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Confirmar participantes.", isCritical: true },
  { id: "cmj_chk_11", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Confirmar entrenador.", isCritical: true },
  { id: "cmj_chk_12", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Confirmar equipo.", isCritical: true },
  { id: "cmj_chk_13", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Confirmar logística.", isCritical: true },
  { id: "cmj_chk_14", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Preparar información.", isCritical: false },
  { id: "cmj_chk_15", role: "coord_maestria", cyclePhase: "PRE-MJ", task: "Identificar aprendizajes del ciclo.", isCritical: false },
  { id: "cmj_chk_16", role: "coord_maestria", cyclePhase: "POST-MJ", task: "Consolidar resultados, asistencia, conversión e incidencias.", isCritical: false },
];
