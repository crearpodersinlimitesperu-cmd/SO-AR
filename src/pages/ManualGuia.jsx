          ...
          <div className="glass-panel" style={{ padding: '2.25rem 2rem', borderRadius: '16px', border: '1px solid rgba(16,185,129,0.3)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
              {[
                ...
                { icon: <Target size={16} />, color: '#10b981', title: 'Estrategia OKRs (Cascade)', desc: 'Objectives & Key Results: cada Objetivo (ej. "Cumplimiento de Metas de Enrolamiento") se descompone en Resultados Clave medibles (ej. "enrolados vs. asignados"), con una barra de progreso que se calcula sola a partir de los datos reales de Nodus del ciclo y sede seleccionados -- no se llenan a mano. Cada OKR muestra tambien quien es el responsable ("owner", ej. Mesa de Registro o Staff Elite). Accesible desde el boton "OKRs (Cascade)" en el dashboard (roles de Direccion/Gerencia).' },
              ].map(item => (
