...
code = code.replace('<option value="C2">3. Reporte Capítulo Dos</option>', '{(canViewLlamadasForm || roles.includes("coord_c2") || role === "coord_c2") && <option value="C2">3. Reporte Capítulo Dos</option>}');
