export const normalizeRole = (role) => {
  ...
  if (r === 'coordinador_mj' || r === 'coord_maestria' || r === 'coordinador_maestria' || r.includes('maestría del juego') || r.includes('maestria del juego') || r === 'coordinador global maestría' || r === 'coordinador global maestria' || (r.includes('coordinador') && r.includes('maestr'))) return 'coord_maestria';
  // Gerentes
  ...
  if (r === 'ceo global' || r === 'cco global' || r === 'socio' || r === 'direccion' || r === 'dirección' || r === 'dirección global' || r === 'direccion global' || r.includes('dirección global') || r.includes('direccion global')) return 'direccion';
  // CFO / Finanzas
