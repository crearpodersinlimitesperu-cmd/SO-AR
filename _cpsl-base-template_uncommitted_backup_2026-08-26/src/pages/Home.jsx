    ...
    <div style={{ maxWidth: '900px', margin: '0 auto', padding: '2rem 1rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'flex-end' }}>
          ...
          {(currentUser?.isSuperAdmin || ['gerente', 'direccion', 'director_maestria', 'coord_c1', 'coord_maestria', 'coordinador', 'finanzas', 'cfo', 'entrenador_llamadas'].includes(currentUser?.appRole)) && (
          ...
          {(currentUser?.isSuperAdmin || ['gerente', 'direccion', 'director_maestria', 'coord_c1', 'coord_maestria', 'coordinador', 'finanzas', 'cfo'].includes(currentUser?.appRole)) && (
