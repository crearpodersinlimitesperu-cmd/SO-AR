...
(async () => {
  ...
  try {
    ...
    await page.goto('https://imo.crearpslglobal.com/maestria/equipo/111/TFD', { waitUntil: 'networkidle2', timeout: 60000 });
    const html = await page.content();
    fs.writeFileSync('nodus_tfd_dump.html', html);
    console.log("HTML de TFD guardado");
  } catch (err) {
