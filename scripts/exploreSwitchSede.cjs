...
(async () => {
  ...
  try {
    ...
    await page.goto('https://imo.crearpslglobal.com/sedes', { waitUntil: 'networkidle2', timeout: 60000 });
    const html = await page.content();
    fs.writeFileSync('nodus_sedes_dump.html', html);
    console.log("HTML de Sedes guardado");
  } catch (err) {
